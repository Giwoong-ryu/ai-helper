  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="container mx-auto px-4 py-8">
        {/* 도구 체계 5단계 소개 */}
        <div className="rounded-2xl border bg-gradient-to-r from-orange-50 to-amber-50 p-6 mb-8">
          <div className="flex items-center gap-2 mb-4">
            <Layers className="w-5 h-5 text-orange-600" />
            <h3 className="text-lg font-bold text-slate-900">Claude 도구 체계 5단계</h3>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <div className="bg-white rounded-xl p-4 border-2 border-orange-300 text-center shadow-sm">
            ...
            <div className="bg-white rounded-xl p-4 border-2 border-blue-300 text-center shadow-sm">
              <div className="text-xs font-bold text-blue-600 mb-1">LEVEL 1</div>
              <h4 className="font-bold text-slate-800">Commands</h4>
              <p className="text-xs text-slate-500 mt-1">17개 커맨드</p>
            </div>
            <div className="bg-white rounded-xl p-4 border-2 border-emerald-300 text-center shadow-sm">
              <div className="text-xs font-bold text-emerald-600 mb-1">LEVEL 2</div>
              <h4 className="font-bold text-slate-800">Agents</h4>
              <p className="text-xs text-slate-500 mt-1">60개 에이전트</p>
            </div>
            <div className="bg-white rounded-xl p-4 border-2 border-purple-300 text-center shadow-sm">
              <div className="text-xs font-bold text-purple-600 mb-1">LEVEL 3</div>
              <h4 className="font-bold text-slate-800">Skills</h4>
              <p className="text-xs text-slate-500 mt-1">37개 스킬</p>
            </div>
            <div className="bg-white rounded-xl p-4 border-2 border-pink-300 text-center shadow-sm">
              <div className="text-xs font-bold text-pink-600 mb-1">별도</div>
              <h4 className="font-bold text-slate-800">MCP</h4>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl p-4 border border-red-100">
              <ul className="text-sm text-slate-700 space-y-2">
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> &quot;짧게 써달라&quot;고 해도 또 길게 씀</li>
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> 갑자기 &quot;제가 할 수 없습니다&quot; 거부</li>
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> 무료 플랜 메시지 한도 금방 참</li>
              </ul>
            </div>
            <div className="bg-white rounded-xl p-4 border border-red-100">
              <ul className="text-sm text-slate-700 space-y-2">
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> 이미지 생성 기능 없음</li>
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> 웹 검색 기능 없음 (Pro도)</li>
                <li className="flex items-start gap-2"><span className="text-red-400 font-bold">•</span> 토큰 비용이 다른 AI보다 높음</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-8 border-l-4 border-l-blue-500 border-slate-300 bg-white">
          <CardContent className="p-6">
            ...
            <div className="bg-blue-100/50 rounded-lg p-3 flex items-center gap-2">
        ...
        <Card className="mb-8 border-l-4 border-l-emerald-500 border-slate-300 bg-white">
          <CardContent className="p-6">
            ...
            <div className="bg-emerald-100/50 rounded-lg p-3 flex items-center gap-2">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="border-l-4 border-l-purple-500 border-slate-300 bg-white">
            ...
            <CardContent>
              ...
              <div className="mt-4 p-2 bg-purple-100/50 rounded text-xs text-purple-700">
          ...
          <Card className="border-l-4 border-l-pink-500 border-slate-300 bg-white">
            ...
            <CardContent>
              ...
              <div className="mt-4 p-2 bg-pink-100/50 rounded text-xs text-pink-700">
          ...
          <Card className="border-l-4 border-l-amber-500 border-slate-300 bg-white">
            ...
            <CardContent>
              <div className="mb-3">
                ...
                <p className="text-sm text-slate-600">backend-development, javascript-typescript, api-scaffolding, debugging-toolkit, work-history-manager</p>
              </div>
              <div>
                <p className="text-xs text-amber-700 font-medium mb-1">공식 플러그인</p>
                <p className="text-sm text-slate-600">document-skills, code-quality-hooks, document-review-toolkit 등</p>
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 font-semibold text-slate-700">작업</th>
                    <th className="text-right py-2 font-semibold text-slate-700">토큰</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={item.task} className={i % 2 === 0 ? "bg-slate-50" : ""}>
                      <td className="py-2 text-slate-600">{item.task}</td>
                      <td className="py-2 text-right font-medium text-slate-800">{item.tokens}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <Card className="border-l-4 border-l-green-500 border-slate-200">
            ...
            <CardContent>
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 font-semibold text-slate-700">플랜</th>
                    <th className="text-center py-2 font-semibold text-slate-700">일일 토큰</th>
                    <th className="text-center py-2 font-semibold text-slate-700">대화/일</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-slate-50">
                    <td className="py-2 text-slate-600">Free</td>
